<?php
	...
	else
	{
		...
		$stmt = $conn->prepare("INSERT INTO RegisteredUsers (firstName, lastName, loginName, email, password) VALUES (?, ?, ?, ?, ?)");
		$stmt->bind_param("sssss", $firstName, $lastName, $loginName, $email, $hashedPassword);
